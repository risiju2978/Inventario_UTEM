              ...
              usuarios.map((usuario) => (
                <tr key={usuario.user_id}>
                  ...
                  <td>
                    ...
                    {usuario.user_state === 1 ? <button type="button" className="btn btn-danger mx-2" onClick={() => banearUsuario(usuario.user_id, 0)}><i className="bi bi-file-earmark-x"></i></button> : <button type="button" className="btn btn-success mx-2" onClick={() => banearUsuario(usuario.user_id, 1)}>
